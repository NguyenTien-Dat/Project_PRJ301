                        ...
                        <div class="blog-sidebar">
                            <div class="block">
                                ...
                                <div class="list-group">
                                    ...
                                    <a href="ControllerProducts?do=Category&cate=1" class="list-group-item"> Romantic Movie </a>
                                    <a href="ControllerProducts?do=Category&cate=1" class="list-group-item"> Comedy Movie </a>
                                    <a href="ControllerProducts?do=Category&cate=1" class="list-group-item"> Horror Movie </a>
                                    <a href="ControllerProducts?do=Category&cate=1" class="list-group-item"> Science Fiction Movie </a>
                                    <a href="ControllerProducts?do=Category&cate=1" class="list-group-item"> Adventure Movie </a>
                                </div>
                            </div>
                            <div class="block">
                                <h4>Sort by:</h4>
